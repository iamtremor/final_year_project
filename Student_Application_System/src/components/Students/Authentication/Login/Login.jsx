          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-6">
            <div className="space-y-6">
              ...
              <div className="flex justify-end">
                <Link to="/student/forgot-password" className="text-sm font-medium text-[#1E3A8A] hover:text-[#152a63]">
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 text-center">
              <p className="text-gray-600">
                ...
                <Link to="/student/signup" className="text-[#1E3A8A] hover:text-[#152a63] font-medium inline-flex items-center">
                  Register now
