...
const Signup = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axios.post('/api/auth/staff/register', formattedData);
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-6 border-b border-gray-100">
            <h2 className="text-lg font-bold text-gray-900">Create Your Staff Account</h2>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-6">
            ...
            <div className="mt-8 pt-6 border-t border-gray-100">
              <div className="flex flex-col-reverse sm:flex-row sm:justify-between sm:items-center gap-4">
                <Link to="/staff/login" className="text-[#1E3A8A] hover:text-[#152a63] text-sm font-medium flex items-center justify-center sm:justify-start">
