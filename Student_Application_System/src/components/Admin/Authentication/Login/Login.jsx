      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-2xl font-bold text-[#1E3A8A] flex items-center justify-center">
            <MdOutlineAdminPanelSettings className="mr-2 text-[#1E3A8A]" size={28} />
            Admin Login
          </h1>
          <p className="text-gray-600 mt-2">Welcome back to the administration panel</p>
        </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-6">
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    id="adminId"
                    type="text"
                    className={`pl-10 w-full h-11 border ${errors.adminId ? 'border-red-500' : 'border-gray-300'} rounded-md focus:ring-[#1E3A8A] focus:border-[#1E3A8A] shadow-sm`}
              ...
              <div className="flex justify-end">
                <Link to="/admin/forgot-password" className="text-sm font-medium text-[#1E3A8A] hover:text-[#152a63]">
                  Forgot password?
                </Link>
              </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full h-11 bg-[#C3A135] hover:bg-[#a58829] text-white rounded-md transition-colors flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#C3A135]"
              >
                {isLoading ? (
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 text-center">
              <p className="text-gray-600">
                ...
                <Link to="/admin/signup" className="text-[#1E3A8A] hover:text-[#152a63] font-medium inline-flex items-center">
                  Sign up now
